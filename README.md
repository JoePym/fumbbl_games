...
and Git. If you want to run it on a windows machine, the same still applies...but I'm not sure how much milage you'll get. If you've got any problems with anything here, drop me a PM, or open an issue on github, and I'll look at fixing it.
